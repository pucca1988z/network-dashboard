<template>
  <div
      class="text-2xl border rounded-t-lg h-12 purple-to-green-header flex items-center flex-row px-4 space-x-2"
  >
    <div 
      class="flex space-x-2"
    >
      <svg 
        class="h-7 w-7 fill-current text-white cursor-pointer" 
