<template>
  <div class="py-2 px-4 flex flex-col content-center ">
    ...
    >
      ...
      <div class="flex-1 border  border-black border-opacity-20 px-2 py-1">{{ data.name }}</div>
      <div class="flex-1 border  border-black border-opacity-20 px-2 py-1">連線狀態</div>
      <div class="flex-1 border  border-black border-opacity-20 px-2 py-1">已連線</div>
    </div>
